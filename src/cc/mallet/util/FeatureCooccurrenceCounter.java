...
public class FeatureCooccurrenceCounter {
	...
	IntIntOpenHashMap[] featureFeatureCounts;
	...
	public FeatureCooccurrenceCounter (InstanceList instances) {
		...
		featureFeatureCounts = new IntIntOpenHashMap[numFeatures];
		for (int feature = 0; feature < numFeatures; feature++) {
			featureFeatureCounts[feature] = new IntIntOpenHashMap();
		}
	...
	public void count() {
        ...
        IntIntOpenHashMap featureCounts = new IntIntOpenHashMap();
		...
		for (Instance instance: instances) {
			...
			featureCounts = new IntIntOpenHashMap();
	...
	public void printCounts() throws IOException {
		...
		for (int feature = 0; feature < numFeatures; feature++) {
			...
			IntIntOpenHashMap featureCounts = featureFeatureCounts[feature];
			int[] keys = featureCounts.keys().toArray();
