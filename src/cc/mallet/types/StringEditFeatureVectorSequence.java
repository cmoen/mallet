...
public class StringEditFeatureVectorSequence extends FeatureVectorSequence implements Serializable
{
  ...
  private ObjectIntOpenHashMap string1Present, string2Present;
  private ObjectIntOpenHashMap lexicon;
  ...
  public StringEditFeatureVectorSequence(FeatureVector[] featureVectors, String s1, String s2, char delimiter, HashMap lexic)
  {
    ...
    this.lexicon = new ObjectIntOpenHashMap();
    if (lexic != null) {
    ...
    string1Present = new ObjectIntOpenHashMap();
    string2Present = new ObjectIntOpenHashMap();
  ...
  private void readObject (ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    if (size == NULL_INTEGER) {
      ...
      ObjectIntOpenHashMap string1Present = (ObjectIntOpenHashMap) in.readObject();
      ObjectIntOpenHashMap string2Present = (ObjectIntOpenHashMap) in.readObject();
      ObjectIntOpenHashMap lexicon = (ObjectIntOpenHashMap) in.readObject();
