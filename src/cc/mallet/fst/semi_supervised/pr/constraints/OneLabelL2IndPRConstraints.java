...
public class OneLabelL2IndPRConstraints implements PRConstraint {
  ...
  protected IntObjectOpenHashMap<OneLabelL2IndPRConstraint> constraints;
  ...
  public OneLabelL2IndPRConstraints(boolean normalized) {
    ...
    this.constraints = new IntObjectOpenHashMap<OneLabelL2IndPRConstraint>();
    // this will be set by the PRTrainer
    this.map = null;
    this.cache = new IntArrayList();
  }
  
  protected OneLabelL2IndPRConstraints(IntObjectOpenHashMap<OneLabelL2IndPRConstraint> constraints,
