...
public abstract class OneLabelGEConstraints implements GEConstraint {
  ...
  protected IntObjectOpenHashMap<OneLabelGEConstraint> constraints;
  ...
  public OneLabelGEConstraints() {
    this.constraints = new IntObjectOpenHashMap<OneLabelGEConstraint>();
    this.cache = new IntArrayList();
  }
  
  protected OneLabelGEConstraints(IntObjectOpenHashMap<OneLabelGEConstraint> constraints, StateLabelMap map) {
