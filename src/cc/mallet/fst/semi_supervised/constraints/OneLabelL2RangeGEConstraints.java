...
public class OneLabelL2RangeGEConstraints implements GEConstraint {
  ...
  protected IntObjectOpenHashMap<OneLabelL2IndGEConstraint> constraints;
  ...
  public OneLabelL2RangeGEConstraints() {
    this.constraints = new IntObjectOpenHashMap<OneLabelL2IndGEConstraint>();
    this.cache = new IntArrayList();
  }
  
  protected OneLabelL2RangeGEConstraints(IntObjectOpenHashMap<OneLabelL2IndGEConstraint> constraints, StateLabelMap map) {
