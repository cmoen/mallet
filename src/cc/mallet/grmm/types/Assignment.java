...
public class Assignment extends AbstractFactor implements Serializable {
  ...
  transient ObjectIntOpenHashMap var2idx;
  ...
  public Assignment ()
  {
    ...
    var2idx = new ObjectIntOpenHashMap ();
  ...
  {
    var2idx = new ObjectIntOpenHashMap (vars.length);
    values = new ArrayList ();
  ...
  {
    var2idx = new ObjectIntOpenHashMap (vars.size ());
    values = new ArrayList ();
  ...
  {
    var2idx = new ObjectIntOpenHashMap (mdl.numVariables ());
    values = new ArrayList ();
  ...
  public Assignment getRow (int ridx)
  {
    ...
    assn.var2idx = (ObjectIntOpenHashMap) this.var2idx.clone ();
  ...
  public Factor duplicate ()
  {
    ...
    ret.var2idx = (ObjectIntOpenHashMap) var2idx.clone ();
