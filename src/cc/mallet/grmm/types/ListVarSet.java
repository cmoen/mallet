...
public class ListVarSet extends AbstractSet implements VarSet, Serializable {
  ...
  transient private IntArrayList included;

  public ListVarSet (Universe universe, Collection included)
  {
    this.universe = universe;
    this.included = new IntArrayList (included.size ());
...
//    this.included.sort ();      
    dumbSort(this.included);
  }

  // Very dumb in-place sort - should be rewritten
