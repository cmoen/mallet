...
public class FactorGraph implements Factor {
  ...
  /**
	 ...
	 */
	final private HashMap clique2ptl = new HashMap ();

  private Universe universe;
  private IntIntOpenHashMap projectionMap;
  ...
  private void setCachesCapacity (int n)
    ...
    if (projectionMap == null) {
      projectionMap = new IntIntOpenHashMap (n);
  ...
  private void removeFactorsOfVariable (final Variable var)
    ...
    for (Object key : clique2ptl.keySet()) {
      VarSet clique = (VarSet) key;
      if (clique.contains(var)) {
        clique2ptl.remove(var);
      }
    }
	}
...
* where C ranges over all cliques for which factors have been defined.
   ...
   **************************************************************************/
	...
	transient HashMap inferenceCaches = new HashMap();
