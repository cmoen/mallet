...
public class ACRF implements Serializable {
  ...
  transient private Map graphCache = new HashMap ();
...
//TODO:	public static class UnrolledGraph extends FactorGraph
  //	implements Compactible
  {
    ...
    private HashMap uvsMap = new HashMap ();
    ...
    ObjectIntOpenHashMap observedVars = new ObjectIntOpenHashMap ();

    private boolean isObserved (Variable var)
    {
      return observedVars.containsKey(var);
    }
