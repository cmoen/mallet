...
public class MessageArray {
  ...
  {
    private java.util.Iterator<IntObjectCursor> subIt;
    private IntObjectCursor cursor;
    private int toIdx = -1;
    ...
    public Factor next () { cursor = subIt.next (); return currentMessage (); }

    int currentFromIdx () { return cursor.key; }
    public Factor currentMessage () { return (Factor) cursor.value; }
